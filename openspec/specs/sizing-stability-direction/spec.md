...
本 change 的 canonical Requirements 載於 `docs/superpowers/specs/sizing-stability-direction-spec.md`；candidate MUST 滿足該規格的全部驗收條件，且 verify／review 以該規格為唯一需求來源。
