...
- [x] 1.1 RED：`tests/test_porcelain_service.py`（install/start/stop/restart 成對驗證、status 三模式與版本、logs 兩來源、uninstall/--purge、`--json`）。
- [x] 1.2 `paulsha_cortex/porcelain/service.py` 七子命令實作 + 復用 `_runtime_probe`。
