...
- [x] **T06 tests／I01/I02/I07**：新增 tests/test_recovery_registry_receipt_497.py；覆蓋 legacy bytes/read/reload、receipt/disposition 未知 version 與 disposition 未知鍵、完整 golden request、ID/digest/target 負例、nested mutation copy、complete historical replay。
