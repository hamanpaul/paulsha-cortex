...
_CODEX_CREDENTIAL = Path(_ISOLATED_AGENTS_ROOT) / "config/codex-credentials/builder/auth.json"
_CODEX_CREDENTIAL.parent.mkdir(parents=True)
_CODEX_CREDENTIAL.write_text("{}\n")
