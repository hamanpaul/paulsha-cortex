...
- 原始盤點以 `main` 的 `7fa4716b` 與 97 張 open issue 為基準，含總帳 #868。逐票 triage 覆蓋其餘 96 張；其中 25 張不在 #868 原 137 張分類表內。2026-09-23 14:29 UTC 最新合併的規劃 PR 為 #981，`main` 是 `e657650b`，`VERSION` 仍為 `0.1.10`；版本 `0.1.11` 尚未建立。
- 盤點後建立 #961–#973、#975–#980、#982–#983 共 21 張 issue，分解 #887／#847／#818／#547／#943 的 Red 規模；它們不在原始 97 張之內。#974／#981 是已合併規劃 PR，#984 是 preflight 環境修復 PR，皆不是 issue。父票維持 open，完整 aggregate acceptance 不因拆票縮減。
