...
- 盤點後建立 #961–#973、#975–#980、#982–#983、#987–#990、#992–#994、#995–#997 及 #999–#1005 共 38 張 issue，分解 #887／#847／#818／#547／#943 的 Red 規模；它們不在原始 97 張之內。#974／#981 是已合併規劃 PR，#984 是已合併的 preflight 環境修復 PR；#985 是待合併的第三批規劃 PR，#986／#991／#998 是產品 PR，皆不是 issue。父票維持 open，完整 aggregate acceptance 不因拆票縮減。
...
- 原始 14 張定版票、18 張可並行後續票、61 張 deferred 票、#564/#807 兩張待重新核對的關票候選，加上 #862 與 #868，共 97 張。新建的 38 張 issue 承接五張 Red 父票與其必要前置，不重複計入原始分類。這是排程分類，不變更 issue label 或關票狀態。
...
| State integrity | #862 → #966 → #967（父票 #818）→ #481；#479 → #968 → #969 → #970 → #971（父票 #547） | #968 已收斂為 A1；#547 AC7 分由 #999–#1005 的無循環子票承接，#862 契約接受、#969 marker 與真跨 UID proof 仍是前置；#547 保持 open。重疊的 registry／Manager recovery 修改由單一 owner 串行。 |
...
#975／#976／#983 的 accepted 三件套與 work item 已在 PR #985，產品實作各待前置合併。#987–#990、#992–#994、#995–#997 的 live issue 已建立，accepted 三件套與 work item 分別在後續獨立規劃分支；合併前不得正式 intake。#978、#973 仍是 Red umbrella；#968 A1 與 #547 AC7 子票 #999–#1005 已凍結 accepted 規劃、產品實作仍待前置；#972 的四張 Yellow 子票需依序落地並回父票整合驗收。#979／#980／#982 的 live issue 依賴已分別改接 #992+#993、#992–#994+#982+#983、#992+#994，解除等待 #978 aggregate 完成的循環。#977 的三張前置 #995–#997 已建 live issue；產品實作仍等 #975 proof shape 與全部前置合併。#964／#965／#967／#969／#970／#971 依前置合併順序進件。草稿 frontmatter 的 `accepted` 不等於已發布 authority。
