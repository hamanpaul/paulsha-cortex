...
- **#1054 build 前 Todo admission 規劃**：修正 Manager first-Builder gate 契約，明定 Todo qualification、latest successful Monitor generation 與 WorkAuthority freshness 由硬依賴 #1063/#1064/#1065 提供；加入 exact run/claim reconciliation、stale direct resume fail-closed 和 pre-Builder exact abandon→new start 邊界。本 Draft PR 僅交付規劃，不含產品程式碼或正式 intake。
