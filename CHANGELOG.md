...
- **#1077 Monitor attempt ledger 規劃**：新增 issue 綁定的 Superpowers spec/design/todo 與獨立 OpenSpec change，定義 refresh 前持久化 generation、per-repo failure marker 與 fail-closed 邊界；本次只交付規劃。
