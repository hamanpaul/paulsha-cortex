...
- **#1063 canonical Todo source qualification plan**：新增 issue-backed spec/design/Todo、OpenSpec delta 與唯一 work item binding；產品 qualification 與 path-link guard 尚未實作。
