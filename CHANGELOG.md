...
- **#988 typed main-sync diagnostics 規劃**：發布 accepted spec／design／todo 與唯一 work item 綁定；補上 #987 在合法 C 前失敗時的 durable null-Candidate context，原始非法／縮寫輸入僅留 probe evidence 且不得進 retry-build；#987 implementation 完成前不進行本票實作。
