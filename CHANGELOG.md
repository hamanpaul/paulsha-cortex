...
- **Refine 0.1.11 self-publication producer 進件**：為 #979、#980、#982 發布 accepted 規劃與 work item，並補正 #992/#993 的 planning discriminator、claim 綁定及整批 append 契約；產品實作、#847 AC10 canary 與定版仍待驗收。
