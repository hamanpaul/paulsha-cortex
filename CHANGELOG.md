...
- **#1051 Superpowers-only ship Todo admission 規劃草案**：登記 draft spec／design／Todo 與唯一 work-item binding；完整範圍實算 10／Red，拆成 admission issue #1054 與已有 Candidate／PR recovery issue #1055（#1055 hard-depends on #1054）。沒有標記 accepted、intake 或產品實作。
