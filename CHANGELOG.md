...
- **#1078 Monitor trusted freshness 規劃**：新增 issue-bound draft spec/design/Todo 與 own OpenSpec change，定義 exact correlation input/source revisions、durable WorkSnapshot read-back、同代 success evidence 和唯讀 freshness API；官方 draft sizing 8/10 Red，accepted-status projection 6/10 Yellow；硬依賴 #1077，保留 #1064 umbrella、#1065 consumer 與 #1054 gate 的 owner 順序。本次僅規劃，未實作或 intake。
