...
- **#1069 same-run authority restart 規劃**：建立唯一 issue/work item/OpenSpec 綁定與 draft spec/design/Todo；本規劃消費 #1054/#1068，限定 read-only journal identity check，完整 PR journal reconciliation 留給 #1070。
