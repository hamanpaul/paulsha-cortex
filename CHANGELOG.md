...
- **#1028 status/health 規劃對齊**：依 live issue body 與三則留言更新 spec/design/todo，補上綁定 job exit receipt 的唯讀 `process_exit_observed`／`manager_acceptance=pending` 契約，並記錄 #885／PR #1024 gate owner 與實作等待條件；不變更產品程式、WorkAuthority、Cortex run 或 gate 判準。
