...
- **Refine 0.1.11 legacy identity 子票進件**：為 #968 A1 與 #999–#1005 新增 accepted 規劃及唯一 work item，分開 registry identity、Builder proof、operator 授權與單筆 CAS；#547 aggregate、#862 契約接受與 installed cross-UID runner 仍待驗收。
